    ...
    <Layout>
      ...
      <main className="form-wrapper" role="main">
        ...
        <form method="POST" action="/entries/new">
          ...
          <input id="singer_name_input" name="entry[singer]" type="text" placeholder="entry[singer]" />

          <label htmlFor="songTitle_input">Song title:</label>
          <input id="songTitle_input" name="entry[songTitle]" type="text" placeholder="entry[songTitle]" />
